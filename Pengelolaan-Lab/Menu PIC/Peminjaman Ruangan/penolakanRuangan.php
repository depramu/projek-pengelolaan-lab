    ...
    <div class="mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="pengajuanRuangan.php">Pengajuan Peminjaman Ruangan</a></li>
                    ...
                    <div class="card-body">
                        <form id="formPenolakanRuangan" method="POST">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="pengajuanRuangan.php?id=<?= urlencode($idPeminjamanRuangan) ?>" class="btn btn-secondary">Kembali</a>
